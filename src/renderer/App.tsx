...
import type { ChatGPTAuthStage, ChatGPTAuthStateEvent, UpdateStage, UpdateStateEvent } from '../shared/contracts';
        ...
        <header className="glass-card mb-6 animate-floatin p-4 sm:p-6">
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex flex-col items-end gap-2">
              ...
              <div className="text-right text-xs text-slate-600">{formatAuthSummary(authState)}</div>
